...
compounds and the charge for the adducts wanted. 
...
Below is is what the ideal input for the function looks like: 
```{r}
standard_charged 
```
...
For this first example, we will try to group just a subset of our list of
compounds and run with default parameters:
```{r}
