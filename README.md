...
[![build status](https://github.com/RforMassSpectrometry/MetaboAnnotation/R-CMD-check-bioc/badge.svg)](https://github.com/RforMassSpectrometry/MetaboAnnotation/actions?query=workflow%3AR-CMD-check-bioc)
